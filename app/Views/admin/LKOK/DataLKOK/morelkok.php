                                        ...
                                        <div class="card bg-light">
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-action">
                                                    ...
                                                    if (!$found) { ?>
                                                        <a href="<?= base_url('AdminLK-OK/morelkok/visi/' . $tb_organisasi['o_id'] . '/register') ?>" class="btn btn-primary btn-sm h-100"><i class="fas fa-plus"></i></a>
                                                    <?php } else { ?>
                                                        <a href="<?= base_url('AdminLK-OK/morelkok/visi/' . $item_visi['o_id'] . '/edit') ?>" class="btn btn-warning btn-sm h-100"><i class="fas fa-pencil-alt"></i></a>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-action">
                                                    ...
                                                    if (!$found) { ?>
                                                        <a href="<?= base_url('AdminLK-OK/morelkok/misi/' . $tb_organisasi['o_id'] . '/register') ?>" class="btn btn-primary btn-sm h-100"><i class="fas fa-plus"></i></a>
                                                    <?php } else { ?>
                                                        <a href="<?= base_url('AdminLK-OK/morelkok/misi/' . $item_misi['o_id'] . '/edit') ?>" class="btn btn-warning btn-sm h-100"><i class="fas fa-pencil-alt"></i></a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="card-body">
