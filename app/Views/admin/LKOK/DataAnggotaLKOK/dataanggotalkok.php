...
<?= $this->section('title') ?>
<title>Data Anggota LK/OK &mdash; ARISYA</title>
<?= $this->endSection() ?>
                                ...
                                foreach ($tb_anggotaorganisasi as $data) : ?>
                                    <tr>
                                        ...
                                        <td><?php foreach ($tb_organisasi as $anggota) :
                                            ...
                                            endforeach ?></td>
                                        <td>
                                            <a href="<?= base_url('AdminLK-OK/dataanggotaLK-OK/' . $data['u_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= base_url('AdminLK-OK/datadata/' . $data['u_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
