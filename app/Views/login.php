<?= $this->extend('layout/default_yeti') ?>
...
<form method="POST" action="<?= base_url('login') ?>" class="needs-validation" novalidate="">
	...
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">NPM</label>
		<input type="text" id="loginEmail" maxlength="254" placeholder="Masukan NPM" name="u_npm" />
		<!-- <p class="helper helper1">email@domain.com</p> -->
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" placeholder="Masukan Password" name="u_password" />
