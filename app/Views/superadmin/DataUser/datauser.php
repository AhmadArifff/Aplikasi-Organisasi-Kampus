                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?= base_url(); ?>/SuperAdmin/datauser/registeruser" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                                ...
                                foreach ($tb_user as $user) : ?>
                                    <tr>
                                        ...
                                        <td><?php foreach ($tb_prodi as $data) :
                                                if ($user['u_prodi'] == $data['p_id']) {
                                                    echo $data['p_nama'];
                                                }
                                            endforeach ?></td>
                                        <td><?= $user['u_gender'] ?></td>
                                        <td><?= $user['u_angkatan'] ?></td>
                                        <td><?= $user['u_alamat'] ?></td>
                                        <td>
                                            <a href="<?= base_url('SuperAdmin/datauser/' . $user['u_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= base_url('SuperAdmin/datauser/' . $user['u_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
