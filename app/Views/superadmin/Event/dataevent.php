                            ...
                            <tbody>
                                ...
                                foreach ($tb_event as $event) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('SuperAdmin/dataevent/' . $event['u_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= base_url('SuperAdmin/dataevent/' . $event['u_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
