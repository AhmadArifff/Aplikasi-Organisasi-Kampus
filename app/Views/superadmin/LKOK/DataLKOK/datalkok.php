                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?= base_url(); ?>/SuperAdmin/dataLK-OK/registerLK-OK" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                                ...
                                foreach ($tb_organisasi as $data) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('SuperAdmin/morelkok/' . $data['o_id']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
