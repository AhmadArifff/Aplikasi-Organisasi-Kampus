...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?= base_url(); ?>/coordinator/databaseuser/datauser">Database Users</a></div>
                        ...
                        <form method="post" action="" id="text-editor">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="js-example-basic-single" name="u_referensi" required disabled>
                                        <option value="">--Pilih Upline/Referensi--</option>
                                        <?php foreach ($datauser as $data) { ?>
                                            <option value="<?= $data['u_referensi'] ?>" <?= $tb_user['u_referensi'] == $data['u_id'] ? 'selected' : '' ?>><?= $data['u_nama'] ?></option>
                                        <?php }  ?>
                                    </select>
