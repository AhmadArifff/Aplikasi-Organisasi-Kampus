                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <!-- <a href="<?= base_url(); ?>/Mahasiswa/dataevent/registerevent" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a> -->
                            ...
                            <tbody>
                                ...
                                foreach ($tb_event as $event) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('Mahasiswa/dataevent/' . $event['u_id'] . '/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-href="<?= base_url('Mahasiswa/dataevent/' . $event['u_id'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++;
                                endforeach ?>
